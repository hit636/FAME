...
This is a reproducible offline protocol that mirrors the ICDM paper narrative:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", default="./output/icdm_experiment", help="Experiment output directory.")
...
def main() -> int:
    args = parse_args()
    logger = setup_logger("FAME_EXPERIMENT", log_dir=args.log_dir, log_file="run_icdm_experiment.log")
    started = time.time()
    set_seed(args.seed)
    ...
    try:
        ...
        json_dump({
            "stage": "closed_loop_icdm_experiment",
