...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--strict-experts", action="store_true", help="Disable silent expert fallback for paper-style reproduction.")
    parser.add_argument("--keep-censored-training", action="store_true", help="Do not exclude stockout/outage/unavailable rows during expert training/fingerprinting.")
